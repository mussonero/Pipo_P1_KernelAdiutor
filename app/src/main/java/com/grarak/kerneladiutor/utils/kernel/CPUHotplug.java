...
/////
    public static void setRkSmartCoresSampleRate(int value, Context context) {
        Control.runCommand(String.valueOf(value), HOTPLUG_RK_SMARTCORES_SAMPLE_RATE, Control.CommandType.GENERIC, context);
    }

    public static int getRkSmartCoresSampleRate() {
        return Utils.stringToInt(Utils.readFile(HOTPLUG_RK_SMARTCORES_SAMPLE_RATE));
    }

    public static boolean hasRkSmartCoresSampleRate() {
        return Utils.existFile(HOTPLUG_RK_SMARTCORES_SAMPLE_RATE);
    }
///////
    public static void setRkSmartCoresNrBoostCups(int value, Context context) {
        Control.runCommand(String.valueOf(value), HOTPLUG_RK_SMARTCORES_NR_BOOST_CUPS, Control.CommandType.GENERIC, context);
    }

    public static int getRkSmartCoresNrBoostCups() {
        return Utils.stringToInt(Utils.readFile(HOTPLUG_RK_SMARTCORES_NR_BOOST_CUPS));
    }

    public static boolean hasRkSmartCoresNrBoostCups() {
        return Utils.existFile(HOTPLUG_RK_SMARTCORES_NR_BOOST_CUPS);
    }
//////
    public static void setRkSmartCoresIdleThreshold(int value, Context context) {
        Control.runCommand(String.valueOf(value), HOTPLUG_RK_SMARTCORES_IDLE_THRESHOLD, Control.CommandType.GENERIC, context);
    }

    public static int getRkSmartCoresIdleThreshold() {
        return Utils.stringToInt(Utils.readFile(HOTPLUG_RK_SMARTCORES_IDLE_THRESHOLD));
    }

    public static boolean hasRkSmartCoresIdleThreshold() {
        return Utils.existFile(HOTPLUG_RK_SMARTCORES_IDLE_THRESHOLD);
    }
//////
    public static void setRkSmartCoresBusyThreshold(int value, Context context) {
        Control.runCommand(String.valueOf(value), HOTPLUG_RK_SMARTCORES_BUSY_THRESHOLD, Control.CommandType.GENERIC, context);
    }

    public static int getRkSmartCoresBusyThreshold() {
        return Utils.stringToInt(Utils.readFile(HOTPLUG_RK_SMARTCORES_BUSY_THRESHOLD));
    }

    public static boolean hasRkSmartCoresBusyThreshold() {
        return Utils.existFile(HOTPLUG_RK_SMARTCORES_BUSY_THRESHOLD);
    }
//////
    public static void setRkSmartCoresBoostDownDelay(int value, Context context) {
        Control.runCommand(String.valueOf(value), HOTPLUG_RK_SMARTCORES_BOOST_DOWN_DELAY, Control.CommandType.GENERIC, context);
    }

    public static int getRkSmartCoresBoostDownDelay() {
        return Utils.stringToInt(Utils.readFile(HOTPLUG_RK_SMARTCORES_BOOST_DOWN_DELAY));
    }

    public static boolean hasRkSmartCoresBoostDownDelay() {
        return Utils.existFile(HOTPLUG_RK_SMARTCORES_BOOST_DOWN_DELAY);
    }
/////
    public static boolean hasRkSmartCores() {
        return Utils.existFile(HOTPLUG_RK_SMARTCORES);
    }
////
