...
public interface Constants {
    ...
    String CPU_QUIET_ENABLE = CPU_QUIET + "/rockchip_cpuquiet/enable";
    ...
    String HOTPLUG_RK_SMARTCORES = "/sys/devices/system/cpu/cpuquiet/smartcores";
    String HOTPLUG_RK_SMARTCORES_NR_BOOST_CUPS = HOTPLUG_RK_SMARTCORES + "/nr_boost_cpus";
    String HOTPLUG_RK_SMARTCORES_SAMPLE_RATE = HOTPLUG_RK_SMARTCORES + "/sample_rate";
    String HOTPLUG_RK_SMARTCORES_IDLE_THRESHOLD = HOTPLUG_RK_SMARTCORES + "/idle_threshold";
    String HOTPLUG_RK_SMARTCORES_BUSY_THRESHOLD = HOTPLUG_RK_SMARTCORES + "/busy_threshold";
    String HOTPLUG_RK_SMARTCORES_BOOST_DOWN_DELAY = HOTPLUG_RK_SMARTCORES + "/boost_down_delay";
    String[] HOTPLUG_RK_SMARTCORES_ARRAY = {HOTPLUG_RK_SMARTCORES};


    String HOTPLUG_RK_BALANCED = "/sys/devices/system/cpu/cpuquiet/balanced";
    String HOTPLUG_RK_BALANCED_LEVEL = HOTPLUG_RK_BALANCED + "/balance_level";
    String HOTPLUG_RK_BALANCED_CORE_BIAS = HOTPLUG_RK_BALANCED + "/core_bias";
    String HOTPLUG_RK_BALANCED_DOWN_DELAY = HOTPLUG_RK_BALANCED + "/down_delay";
    String HOTPLUG_RK_BALANCED_IDEL_BOTTOM_FREQ = HOTPLUG_RK_BALANCED + "/idle_bottom_freq";
    String HOTPLUG_RK_BALANCED_IDEL_TOP_FREQ = HOTPLUG_RK_BALANCED + "/idle_top_freq";
    String HOTPLUG_RK_BALANCED_LOAD_SAMPLE_RATE = HOTPLUG_RK_BALANCED + "/load_sample_rate";
    String HOTPLUG_RK_BALANCED_UP_DELAY = HOTPLUG_RK_BALANCED + "/up_delay";
    String[] HOTPLUG_RK_BALANCED_ARRAY = {HOTPLUG_RK_BALANCED};
    ...
    String[][] CPU_HOTPLUG_ARRAY = {{HOTPLUG_MPDEC}, INTELLIPLUG_ARRAY, BLU_PLUG_ARRAY, HOTPLUG_MSM_ARRAY, MAKO_HOTPLUG_ARRAY,
            MB_HOTPLUG_ARRAY, ALUCARD_HOTPLUG_ARRAY, HOTPLUG_THUNDER_PLUG_ARRAY, HOTPLUG_ZEN_DECISION_ARRAY, HOTPLUG_AUTOSMP_ARRAY, HOTPLUG_RK_SMARTCORES_ARRAY /*, HOTPLUG_RK_BALANCED_ARRAY*/};
...
//	demand                   interactive
//	always_on                xinteractive 
//	coarse_demand            ondemand
//	demand_always_powered    xondemand
//	fast_start               performance

//randomize  classic
//fixed      random

    String GPU_GENERIC_GOVERNORS = "interactive Xinteractive ondemand Xondemand performance";

    String GPU_GENERIC_CORES = "classic randomize";
    ...
    String GPU_CUR_SOC0_FFA30000_MALI_FREQ = "/sys/devices/ffa30000.gpu/gpu_cur_freq";
    String GPU_MAX_SOC0_FFA30000_MALI_FREQ = "/sys/devices/ffa30000.gpu/gpu_max_freq";
    String GPU_MIN_SOC0_FFA30000_MALI_FREQ = "/sys/devices/ffa30000.gpu/gpu_min_freq";
    String GPU_AVAILABLE_SOC0_FFA30000_MALI_FREQS = "/sys/devices/ffa30000.gpu/gpu_available_frequencies";
    String GPU_SCALING_SOC0_FFA30000_MALI_GOVERNOR = "/sys/devices/ffa30000.gpu/gpu_cur_governor";
    String GPU_AVAILABLE_SOC0_FFA30000_MALI_GOVERNORS = "/sys/devices/ffa30000.gpu/available_governors";
    String GPU_AUTILISATION_SOC0_FFA30000_MALI_FREQ = "/sys/devices/ffa30000.gpu/gpu_cur_utilisation";
    String GPU_SCALING_SOC0_FFA30000_MALI_CORES = "/sys/devices/ffa30000.gpu/gpu_cur_cores";
    String GPU_AVAILABLE_SOC0_FFA30000_MALI_CORES = "/sys/devices/ffa30000.gpu/gpu_available_cores";
    String GPU_TEMP_SOC0_FFA30000_MALI_TEMP = "/sys/class/thermal/thermal_zone1/temp";
    ...
    String[] GPU_CUR_FREQ_ARRAY = {GPU_CUR_KGSL3D0_QCOM_FREQ, GPU_CUR_FDB00000_QCOM_FREQ, GPU_CUR_FDC00000_QCOM_FREQ,
            GPU_CUR_SOC0_FDB00000_QCOM_FREQ, GPU_CUR_1C00000_QCOM_FREQ, GPU_CUR_OMAP_FREQ, GPU_CUR_TEGRA_FREQ, GPU_CUR_SOC0_FFA30000_MALI_FREQ};

    String[] GPU_MAX_FREQ_ARRAY = {GPU_MAX_KGSL3D0_QCOM_FREQ, GPU_MAX_FDB00000_QCOM_FREQ, GPU_MAX_FDC00000_QCOM_FREQ,
            GPU_MAX_SOC0_FDB00000_QCOM_FREQ, GPU_MAX_1C00000_QCOM_FREQ, GPU_MAX_OMAP_FREQ, GPU_MAX_TEGRA_FREQ, GPU_MAX_SOC0_FFA30000_MALI_FREQ};

    String[] GPU_MIN_FREQ_ARRAY = {GPU_MIN_FDB00000_QCOM_FREQ, GPU_MIN_TEGRA_FREQ, GPU_MIN_SOC0_FFA30000_MALI_FREQ};
    ...
    String[] GPU_AVAILABLE_FREQS_ARRAY = {GPU_AVAILABLE_KGSL3D0_QCOM_FREQS, GPU_AVAILABLE_FDB00000_QCOM_FREQS,
            ...
            GPU_AVAILABLE_OMAP_FREQS, GPU_AVAILABLE_TEGRA_FREQS, GPU_AVAILABLE_SOC0_FFA30000_MALI_FREQS};
    ...
    String[] GPU_SCALING_GOVERNOR_ARRAY = {GPU_SCALING_KGSL3D0_QCOM_GOVERNOR, GPU_SCALING_FDB00000_QCOM_GOVERNOR,
            ...
            GPU_SCALING_1C00000_QCOM_GOVERNOR, GPU_SCALING_OMAP_GOVERNOR, GPU_SCALING_SOC0_FFA30000_MALI_GOVERNOR};
    ...
    String[] GPU_AVAILABLE_GOVERNORS_ARRAY = {GPU_AVAILABLE_FDB00000_QCOM_GOVERNORS, GPU_AVAILABLE_FDC00000_QCOM_GOVERNORS,
	     ...
	     GPU_AVAILABLE_SOC0_FFA30000_MALI_GOVERNORS};

    String[] GPU_AUTILISATION_ARRAY = {GPU_AUTILISATION_SOC0_FFA30000_MALI_FREQ};
    String[] GPU_TEMP_ARRAY = {GPU_TEMP_SOC0_FFA30000_MALI_TEMP};


    String[] GPU_SCALING_CORE_ARRAY = {GPU_SCALING_SOC0_FFA30000_MALI_CORES};
    String[] GPU_AVAILABLE_CORES_ARRAY = {GPU_AVAILABLE_SOC0_FFA30000_MALI_CORES};
    ...
    String[][] GPU_ARRAY = {GPU_2D_CUR_FREQ_ARRAY,
            ...
            GPU_SCALING_GOVERNOR_ARRAY, GPU_AUTILISATION_ARRAY, GPU_SCALING_CORE_ARRAY, {SIMPLE_GPU_PARAMETERS, ADRENO_IDLER_PARAMETERS}};
    ...
    String TOUCHWAKE_RK_T2W = "/sys/class/misc/touchwake/enabled";

    String[] T2W_ARRAY = {TSP_T2W, TOUCHWAKE_RK_T2W};
    ...
    String WAKE_TIMEOUT_3 = "/sys/class/misc/touchwake/delay";

    String[] WAKE_TIMEOUT_ARRAY = {
            WAKE_TIMEOUT, WAKE_TIMEOUT_2, WAKE_TIMEOUT_3
    };
